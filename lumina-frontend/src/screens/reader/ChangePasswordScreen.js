		...
		<View style={styles.field}>
			...
			<View style={styles.passwordRow}>
				...
				<TouchableOpacity onPress={onToggle} style={styles.eyeBtn}>
					<MaterialIcons name={show ? "visibility-off" : "visibility"} size={20} color="#8c4f3b" />
				</TouchableOpacity>
			</View>
		</View>
	);
		...
		<SafeAreaView style={styles.safeArea}>
			...
			<ScrollView contentContainerStyle={styles.content}>
				<View style={styles.notice}>
					<MaterialIcons name="lock" size={20} color="#8c4f3b" />
...
const styles = StyleSheet.create({
	...
	noticeText: { fontSize: 13, color: "#8c4f3b" },
	field: { gap: 6 },
	...
	passwordInput: { flex: 1, paddingHorizontal: 14, paddingVertical: 12, fontSize: 14, color: "#323331" },
	eyeBtn: { padding: 12 },
	saveBtn: {
		backgroundColor: "#8c4f3b", paddingVertical: 14,
